...
183,710 pixel bytes (191,580 bytes with AGNB overhead), plus 2,048 font bytes.
The first 128 records use printed bitmap characters in context 2; the remaining
decorative tiles use direct plots. Context 1 prints ordinary Neutrino text with
a five-pixel advance. Static drawing commands occupy 1,541 bytes. Live packets
...
5,307 pixels, including native glyph strokes/spacing and both normal/selected
