...
def main():
    ...
    comparison_sheet(threshold_rows, ['Source', 'Strict ink', 'Balanced ink', 'Inclusive ink'], out / 'threshold-comparison.png')
    comparison_sheet(comparison_rows, ['Source', 'Balanced mask', 'Tiny cleanup', 'Vector render', 'Contour overlay'], out / 'comparison.png')
    w, h = params['canvas']
