...
from detect import icons_from_rois
...
def main():
    ...
    if params.get('icon_rois'):
        params['icons']=icons_from_rois(source_pixels,params['icon_rois'])
        params['protect_art']=params['icons']
    ...
    write_json(out/'resolved-parameters.json',params)
